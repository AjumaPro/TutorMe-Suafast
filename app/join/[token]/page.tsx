...
export default async function JoinSessionPage({
  ...
  if (!session) {
    redirect(`/auth/signin?callbackUrl=/join/${(await params).token}`)
  }
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="bg-white rounded-xl shadow-md p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              This session has ended. Please contact your tutor for a new session link.
            </p>
            <a
              href="/dashboard"
              className="inline-block px-6 py-3 bg-pink-600 text-white rounded-lg hover:bg-pink-700 transition-colors font-medium"
        ...
        <div className="mb-6">
          ...
          {videoSession.tutor && (
            <p className="text-gray-600">
              Session with {videoSession.tutor.user.name}
